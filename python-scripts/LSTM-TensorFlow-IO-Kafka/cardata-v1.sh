curl -s https://raw.githubusercontent.com/uurl/hivemq-mqtt-tensorflow-kafka-realtime-iot-machine-learning-training-inference/master/testdata/cardata-v1.avsc | awk -v ORS= -v OFS= '{$1=$1}1' > cardata-v1.avsc
